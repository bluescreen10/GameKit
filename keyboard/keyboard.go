// Package keyboard defines portable keyboard keys and native key actions.
package keyboard
...
const (
	KeyReleased KeyAction = 0
	KeyPressed  KeyAction = 1
...
type KeyEvent struct {
	Key    Key
	Action KeyAction // KeyPressed, KeyReleased, or KeyRepeat
	Mods   ModifierKey
}
...
// rate the user configured in their OS (a held Backspace arrives as KeyPressed then a
